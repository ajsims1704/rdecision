...
The monotherapy model is created as follows. Note that in the transition matrix, the
entries of the leading diagonal are set to missing (NA); they will be calculated
by the package to enure that the sum of probabilities from each state is unity.
```{r echo=T}
...
I.mono <- matrix(
  data = c(   NA, tpA2B, tpA2C, tpA2D,
           tpB2A,    NA, tpB2C, tpB2D,
           tpC2A, tpC2B,    NA, tpC2D,
           tpD2A, tpD2B, tpD2C,    NA),
  nrow = 4,
  ncol = 4, 
  byrow = T,
