...
# Introduction
Kamiński *et al* [-@kaminski2018, Fig 7] provide an example of a decision tree
...
# The problem
Kamiński *et al* [-@kaminski2018] state the problem as follows:
...
The decision tree can be drawn using the `draw` method of `DecisionTree`:
