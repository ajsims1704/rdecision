...
end is directly related to the per-cycle probability. As Miller and Homan [-@miller1994], Welton and Ades [-@welton2005], Jones *et al*
...
TM <- m.comb$transition_probability()
pander::pander(TM, emphasize.rownames=FALSE, justify="lcccc")
rm(TM)
```
