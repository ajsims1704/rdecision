...
```{r}
#| purl = FALSE
knitr::kable(Ptm, align = "lcccc", digits = 3L)
```
...
knitr::kable(
  MT.mono[, keep], row.names = FALSE, align = "rrrrrrr",
  digits = c(2L, 0L, 0L, 0L, 0L, 0L, 3L)
)
```
...
```{r}
#| purl = FALSE
knitr::kable(Ptc, align = "lcccc", digits = 3L)
```
...
keep <- c("Years", "A", "B", "C", "D", "Cost", "QALY")
knitr::kable(
  MT.comb[, keep], row.names = FALSE, align = "rrrrrrr",
  digits = c(2L, 0L, 0L, 0L, 0L, 0L, 3L)
)
```
