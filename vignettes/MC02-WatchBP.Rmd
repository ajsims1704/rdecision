...
COHORT <- data.frame(
  ...
  Treatment = c("Aspirin", rep("Anticoagulant", times=6)),
  rBleed = c(1.6, rep(1.4, times=6)),
  rStroke = c(2.8, 2.8, 4.0, 5.9, 8.5, 12.5, 18.2)
)
```
...
E <- list(
  ...
  # from GI bleed
  MarkovTransition$new(GB, AF, r=NULL),
  # from stroke, year 1
  ...
  # abosrbing states
  MarkovTransition$new(D, D),
  MarkovTransition$new(SF, SF)
)
# create model
...
and medication. The annual risk of major GI bleed and annual risk of stroke for
each sub-cohort are shown in the table below. The annual risk of a fatal first
stroke was 
