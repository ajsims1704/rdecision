...
AF state. The fatal stroke and dead states were absorbing states. The stroke 
...
e.AFGB <- MarkovTransition$new(AF, GB, r=0, label="bleed")
...
CM <- CohortMarkovModel$new(
  ...
  E = list(e.AFAF, e.AFGB, e.AFDD, e.AFS1, e.GBAF, e.GBDD, 
