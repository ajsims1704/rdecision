...
# cost variables
c.CRBSI <- GammaModelVariable$new('c.CRBSI', 'CRBSI cost', 'GBP', alpha=198.0, beta=50)
c.Dermatitis <- GammaModelVariable$new('c.Dermatitis', 'Dermatitis cost', 'GBP', alpha=30, beta=5)
c.LSI <- GammaModelVariable$new('c.LSI', 'LSI cost', 'GBP', alpha=50, beta=5)
c.Tegaderm <- ConstModelVariable$new('c.Tegaderm', 'Tegaderm CHG cost', 'GBP', const=6.21)
c.Standard <- ConstModelVariable$new('c.Standard', 'Standard dressing cost', 'GBP', const=1.34)
n.cathdays <- NormalModelVariable$new('n.cathdays', 'No. days with catheter', 'days', mu=10, sigma=2)
n.dressings <- NormalModelVariable$new('n.dressings', 'No. dressings', 'dressings', mu=3, sigma=0.3)
```
