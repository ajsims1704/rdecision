...
rr.Dermatitis <- LogNormalModelVariable$new(
  ...
  'ratio',
  mu=log(4.4), sigma=0.393
)

# cost variables
c.CRBSI <- GammaModelVariable$new('CRBSI cost', 'GBP', alpha=9990/50, beta=50)
...
From PSA, the median cost of treatment with Tegaderm was `r round(median(RES$Tegaderm),2)`,
the median cost of treatment with standard dressings was `r round(median(RES$Standard),2)`
and the median cost saving was `r round(median(RES$Difference),2)`. The 95% confidence 
