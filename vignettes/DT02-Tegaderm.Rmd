...
decision tree edges. For probabilities, the convention $q = 1-p$ is used to 
ensure that the sum of probabilities leaving each chance node sums to one.
...
was cost saving. These results replicate those reported by the manufacturer (saving
of 77.76, 98.5% cases cost saving; mean cost of standard dressing 176.89, mean cost 
of Tegaderm 99.63).
