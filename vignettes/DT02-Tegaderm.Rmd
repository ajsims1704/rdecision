...
```
```{r draw, results="hide", fig.keep="last", fig.align="center", fig.cap=f1c}
DT$draw(border=TRUE)
```
...
model, the input model variable are in the following table. Variables SN1, 
SN2 and SN3 were introduced to model the uncertainties of the hazard and risk 
ratios.
