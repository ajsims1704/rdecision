...
reported by Jenks *et al* [-@jenks:2016a] in which a transparent dressing used 
...
of Jenks *et al* [-@jenks:2016a], with the following additional information:
...
```{r PSA, echo=TRUE}
PSA <- DT$evaluate(expected=F, N=10)
```
...
From PSA (100 runs), the mean cost of treatment with Tegaderm 
