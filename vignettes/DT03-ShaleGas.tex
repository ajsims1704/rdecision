...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# strategies}
\NormalTok{S <-}\StringTok{ }\NormalTok{DT}\OperatorTok{$}\KeywordTok{strategies}\NormalTok{(}\StringTok{"label"}\NormalTok{)}
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(S, }\DataTypeTok{row.names=}\OtherTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
  \CommentTok{# evaluate one strategy (test/sell/sell)}
\NormalTok{  RES <-}\StringTok{ }\NormalTok{DT}\OperatorTok{$}\KeywordTok{evaluate_strategy}\NormalTok{(}\KeywordTok{list}\NormalTok{(E[[}\DecValTok{5}\NormalTok{]],E[[}\DecValTok{7}\NormalTok{]],E[[}\DecValTok{12}\NormalTok{]]))}
  \CommentTok{# find optimal strategies}
\NormalTok{  RES <-}\StringTok{ }\NormalTok{DT}\OperatorTok{$}\KeywordTok{evaluate}\NormalTok{()}
\NormalTok{  imax <-}\StringTok{ }\KeywordTok{which.max}\NormalTok{(RES}\OperatorTok{$}\NormalTok{Benefit}\OperatorTok{-}\NormalTok{RES}\OperatorTok{$}\NormalTok{Cost)}
\NormalTok{  popt <-}\StringTok{ }\KeywordTok{paste}\NormalTok{(RES}\OperatorTok{$}\NormalTok{d1[imax], RES}\OperatorTok{$}\NormalTok{d2[imax], RES}\OperatorTok{$}\NormalTok{d3[imax], }\DataTypeTok{sep=}\StringTok{"/"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
