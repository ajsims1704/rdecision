...
# system) and so dot only needs to be available there, not on any system used
# for checking or installing the vignettes, which operate on the
# versions moved to the doc directory at build time. It is preferable to use
# dot with png output for vignette builds because it creates more compact html.
pngfile <- gv2png(SMM_base$as_DOT(rankdir = "TB"))
