...
A decision tree is a simple decision model that represents all possible pathways
...
knitr::kable(DT_reduced_evaluation)
```
...
plot(DT_evaluation_random$Cost.Diet, DT_evaluation_random$Cost.Exercise, pch=20, 
     xlab="Cost Diet", ylab="Cost Exercise", 
...
hist(DT_evaluation_random$Difference, 100)
knitr::kable(DT_evaluation_random[1:10,c(1,3,8,12)])
...
**TODO: add distribution for utilities in order to be able to plot cost effectiveness plane? **

**TODO: Tornado plot**

## Univariate threshold analysis

**Note: I was trying to include this earlier (before the probabilistic section) by using ConstModVars for costs, but couldn't get it to work**
