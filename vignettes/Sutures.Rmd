...
n.sutures <- GammaModVar$new(
  "Sutures per procedure",
  "n",                    # Gamma is conjugate prior of Poisson mean
...
e6 <- Action$new(d1,c2,label="Non-antimicrobial",cost=c.NCS,benefit=0)
# tree
...
### Tornado diagram
```{r tornado_tab}
TO <- DT1$tornado(index=list(e3), ref=list(e6), draw=FALSE)
pander::pander(TO)
```
