...
[![Codecov test coverage](https://codecov.io/gh/ajsims1704/rdecision/branch/master/graph/badge.svg)](https://codecov.io/gh/ajsims1704/rdecision?branch=master)
<!-- badges: end -->
...
```{r sb,echo=FALSE,results="hide",fig.keep="last",fig.align="center"}
#DOT <- M$as_DOT()
...
In Markov models, matrix exponentiation for converting transition rates into
per-cycle probabilities, and *vice versa*, relies on the `expm` 
package [@goulet2021] and Markov model representations are exported in the
