...
test_that("tunnel states are recognised as not memoryless", {
  # create the states
...
test_that("tunnel states with 2 sinks are recognised as not memoryless", {
  # create the states
  s.a <- MarkovState$new("A")
...
test_that("rates violating continuity are recognised", {
  # create the states
  s.a <- MarkovState$new("A")
  s.b <- MarkovState$new("B")
  s.c <- MarkovState$new("C")
  ...
  # create the transitions
  t.aa <- MarkovTransition$new(s.a, s.a)
  t.bb <- MarkovTransition$new(s.b, s.b)
  t.cc <- MarkovTransition$new(s.c, s.c)
  t.dd <- MarkovTransition$new(s.d, s.d)
  t.ab <- MarkovTransition$new(s.a, s.b, r=1)
  t.bc <- MarkovTransition$new(s.b, s.c, r=2)
  t.bd <- MarkovTransition$new(s.b, s.d, r=2)
  # create the model
  M <- CohortMarkovModel$new(
    V = list(s.a, s.b, s.c, s.d),
    E = list(t.aa, t.bb, t.cc, t.dd, t.ab, t.bc, t.bd)
  )
  # check the transition rates
  Q <- M$transition_rate()
  print(Q)
  # check the transition probabilities
  Pt <- M$transition_probability(tcycle=as.difftime(365.25/12, units="days"))
  print(Pt)
  expect_true(TRUE)
})

test_that("rates violating continuity are recognised (2)", {
  # create the states
  s.a <- MarkovState$new("A")
  s.b <- MarkovState$new("B")
  # create the transitions
  ...
  t.bb <- MarkovTransition$new(s.b, s.b)
  t.ab <- MarkovTransition$new(s.a, s.b, r=1)
  t.ba <- MarkovTransition$new(s.b, s.a, r=1)
  # create the model
  M <- CohortMarkovModel$new(
    V = list(s.a, s.b),
    E = list(t.aa, t.bb, t.ab, t.ba)
  )
  # check the transition rates
  Q <- M$transition_rate()
  print(Q)
